	...
	try
	{
		...
		for (int i = 0; i < Rs_decomp.size(); i++)
		{
			...
			if (isRotationMatrix(Rs_decomp[0]))
			{
				...
				cout << "x轴旋转角度：" << oula[0] * 180 / 3.14159265358979323846 << endl;
				cout << "y轴旋转角度：" << oula[1] * 180 / 3.14159265358979323846 << endl;
				cout << "z轴旋转角度：" << oula[2] * 180 / 3.14159265358979323846 << endl;
			}
			else
			{
				cout << "没有计算出欧拉角" << endl;
