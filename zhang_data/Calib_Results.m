...
%-- Focal length:
fc = [ 832.956785740093320 ; 832.895098525060690 ];

%-- Principal point:
cc = [ 304.145544226842670 ; 208.605342171200790 ];

%-- Skew coefficient:
alpha_c = 0.000000000000000;

%-- Distortion coefficients:
kc = [ -0.228696619564418 ; 0.179280182900685 ; 0.001048912748327 ; 0.000110331429729 ; 0.000000000000000 ];

%-- Focal length uncertainty:
fc_error = [ 4.381283782317386 ; 4.312750234179120 ];

%-- Principal point uncertainty:
cc_error = [ 2.265903274857439 ; 2.216595556974355 ];
