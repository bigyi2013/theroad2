...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . iujc0na3l0
) , 0 , 0 , 39 } , { ( char_T * ) ( & rtDW . nrmukcfwfd . AQHandles ) , 11 ,
0 , 7 } , { ( char_T * ) ( & rtDW . msfc3xs1lc ) , 10 , 0 , 9 } , { ( char_T
* ) ( & rtDW . igwhvclklu ) , 2 , 0 , 5 } } ; static DataTypeTransitionTable
rtBTransTable = { 4U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . Integrator1_IC ) , 0 , 0 , 23
